...
const DevicePage = () => {
    const device = {id: 1, name: 'Iphone 12 pro', price: 25000, rating: 5, brandId: 1, typeId: 2, img: "https://cdn1.ozone.ru/s3/multimedia-n/6069408023.jpg"}
    const description = [
                ...
                <Col md={4}>
                    <Row className='d-flex flex-column align-items-center'>
                        ...
                        <div
                            ...
                            style={{background: `url(${starRating}) no-repeat center center`, width: 240, height: 240, backgroundSize: 'cover', fontSize: 64}}
                        >
                            {device.rating}
                        </div>
                    </Row>
